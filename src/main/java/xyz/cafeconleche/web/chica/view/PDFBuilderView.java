...
public class PDFBuilderView extends AbstractITextPdfView {

	@Override
	public void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter pdfWriter,
		...
		Image mouth = getImage("noses/" + face.getMouth());
